...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Graphviz_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3c863552-8265-54e4-a6dc-903eb78fde85"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Graphviz", artifacts_toml) for e in artifacts["Graphviz"]]
...
if best_platform === nothing
    @debug("Unable to load Graphviz; unsupported platform $(triplet(platform_key_abi()))")
else
