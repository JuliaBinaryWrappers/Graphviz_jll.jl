# Autogenerated wrapper script for Graphviz_jll for x86_64-apple-darwin14-cxx11
...
const libcdt_splitpath = ["lib", "libcdt.5.dylib"]
...
const libcdt = "@rpath/libcdt.5.dylib"


# Relative path to `libcgraph`
const libcgraph_splitpath = ["lib", "libcgraph.6.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libcgraph = "@rpath/libcgraph.6.dylib"


# Relative path to `libgvc`
const libgvc_splitpath = ["lib", "libgvc.6.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libgvc = "@rpath/libgvc.6.dylib"


# Relative path to `libgvpr`
const libgvpr_splitpath = ["lib", "libgvpr.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libgvpr = "@rpath/libgvpr.2.dylib"


# Relative path to `liblab_gamut`
const liblab_gamut_splitpath = ["lib", "liblab_gamut.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const liblab_gamut = "@rpath/liblab_gamut.1.dylib"


# Relative path to `libpathplan`
const libpathplan_splitpath = ["lib", "libpathplan.4.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libpathplan = "@rpath/libpathplan.4.dylib"


# Relative path to `libxdot`
const libxdot_splitpath = ["lib", "libxdot.4.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libxdot = "@rpath/libxdot.4.dylib"
